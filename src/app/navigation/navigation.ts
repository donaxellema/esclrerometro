...
export const navigation: FuseNavigation[] = [
    ...
    //{"id" : "bodeguero-new", "title" : "BODEGUERO-NEW", "type" : "group", "icon" : "apps", "children" : [{"id":"ingresos","title":"Ingresos","type":"collapsable","icon":"dashboard","children":[{"id":"nota de ingreso","title":"Nota de Ingreso","type":"item","url":"ningreso"}]}]},{"id" : "adminbode", "title" : "ADMINBODE", "type" : "group", "icon" : "apps", "children" : [{"id":"administrar","title":"Administrar","type":"collapsable","icon":"folder","children":[{"id":"años fiscales","title":"Años Fiscales","type":"item","url":"anios"}]}]}
];
